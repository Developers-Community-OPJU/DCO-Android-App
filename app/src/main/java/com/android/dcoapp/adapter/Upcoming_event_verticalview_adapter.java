...
public class Upcoming_event_verticalview_adapter extends RecyclerView.Adapter<Upcoming_event_verticalview_adapter.Upcoming_event_vertical_viewHolder> {

    private Context context;
    private List<Event> eventList;

    public Upcoming_event_verticalview_adapter(Context context, List<Event> eventList){
    ...
    @NonNull
    @Override
    public Upcoming_event_vertical_viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.event_cards, parent, false);
        return new Upcoming_event_vertical_viewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Upcoming_event_vertical_viewHolder holder, int position) {
    ...
    public class Upcoming_event_vertical_viewHolder extends RecyclerView.ViewHolder {

        TextView titletxt, organizertxt, venuetxt, datetxt, timetxt;

        public Upcoming_event_vertical_viewHolder(@NonNull View itemView) {
            super(itemView);
