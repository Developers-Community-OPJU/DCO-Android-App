...
public class Past_event_adapter extends RecyclerView.Adapter<Past_event_adapter.Past_event_Viewholder> {

    private Context context;
    private List<Event> eventList;
    private int MAX_CARD_LIMIT = 4;

    public Past_event_adapter(Context context, List<Event> eventList){
    ...
    @NonNull
    @Override
    public Past_event_Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(context);
        View view = layoutInflater.inflate(R.layout.event_cards, parent, false);
        return new Past_event_Viewholder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Past_event_Viewholder holder, int position) {
    ...
    public class Past_event_Viewholder extends RecyclerView.ViewHolder {

        TextView titletxt, organizertxt, venuetxt, datetxt, timetxt;

        public Past_event_Viewholder(@NonNull View itemView) {
            super(itemView);
